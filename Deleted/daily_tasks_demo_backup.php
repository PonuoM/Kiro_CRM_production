...
$additionalJS = "
    <script>
        class DailyTasksManager {
            ...
            async loadTaskStats() {
                try {
                    const response = await fetch('../api/tasks/daily_simple_fast.php');
            ...
            async loadTodayTasks() {
                ...
                try {
                    ...
                    if (data.success && data.data && data.data.today) {
                        if (data.data.today.tasks && data.data.today.tasks.length > 0) {

    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="page-description">
                แดชบอร์ดการจัดการทีมและติดตามประสิทธิภาพ | User: <?php echo htmlspecialchars(Permissions::getCurrentUser()); ?> (<?php echo htmlspecialchars(Permissions::getCurrentRole()); ?>)
            </p>
        </div>
        <div>
...
$additionalJS = '
    ...
    <script>
        ...
        const apiPath = "/Kiro_CRM_production/api/";
        ...
        function loadKeyMetrics() {
            ...
            Promise.all([
                fetch(apiPath + 'distribution/basket.php').then(r => r.json()),
                fetch(apiPath + 'customers/intelligence-safe.php?action=summary').then(r => r.json()),
                fetch(apiPath + 'distribution/basket.php?action=assignment_stats').then(r => r.json())
        ...
        function loadRecentActivity() {
            ...
            fetch(apiPath + 'distribution/basket.php?action=recent_assignments&limit=10')
                .then(response => response.json())
                .then(data => {
        ...
        function loadIntelligenceData() {
            Promise.all([
                fetch(apiPath + 'customers/intelligence-safe.php?action=grades').then(r => r.json()),
                fetch(apiPath + 'customers/intelligence-safe.php?action=temperatures').then(r => r.json())

        ...
        <div class="card text-center shadow-sm border border-primary bg-white">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="card-title text-primary mb-1" id="totalOrders">-</h3>
    ...
    <div class="col-md-3">
        <div class="card text-center shadow-sm border border-success bg-white">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="card-title text-success mb-1" id="todayOrders">-</h3>
    ...
    <div class="col-md-3">
        <div class="card text-center shadow-sm border border-info bg-white">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="card-title text-info mb-1" id="monthOrders">-</h3>
    ...
    <div class="col-md-3">
        <div class="card text-center shadow-sm border border-warning bg-white">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="card-title text-warning mb-1" id="totalSales">-</h3>
    ...
    <script>
        class SalesRecordsManager {
            ...
            async loadSalesRecords() {
                ...
                try {
                    const response = await fetch("../api/sales/sales_records_fixed.php");
            ...
            updateStats(stats) {
                // แสดงจำนวนออเดอร์
                document.getElementById("totalOrders").textContent = this.formatNumber(stats.total_orders || 0);
                document.getElementById("todayOrders").textContent = this.formatNumber(stats.today_orders || 0);
                document.getElementById("monthOrders").textContent = this.formatNumber(stats.month_orders || 0);
...
" + (sale.CustomerTel ? 
                                                "<button class=\"btn btn-outline-info\" onclick=\"callCustomer('" + sale.CustomerTel + "')\"><i class=\"fas fa-phone\"></i></button>" : "") + "
                                            </div>
                                        </td>
                                    </tr>
                                `).join("")}
            ...
            formatNumber(number) {
                ...
                return parseInt(number).toLocaleString("th-TH");
            }
        ...
        function callCustomer(phoneNumber) {
            if (phoneNumber) {
                if (confirm("โทรหา " + phoneNumber + " หรือไม่?")) {

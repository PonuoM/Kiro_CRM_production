...
// Get user information from session (bypass complex permission system)
$currentUser = $_SESSION['username'] ?? 'Unknown';
$currentRole = $_SESSION['user_role'] ?? 'Unknown';

// Complete menu items (avoid permissions complexity)
$menuItems = [
    // Dashboard
    ...
    ['url' => 'daily_tasks_demo.php', 'title' => 'งานประจำวัน', 'icon' => '📅'],

<?php
/**
 * Admin Layout with ShadCN UI Style Sidebar
 * Modern UI with White-Black-Green color scheme
 */
...
// Get user information from GLOBALS (set by calling page) or fallback to session
$currentUser = $GLOBALS['currentUser'] ?? $_SESSION['username'] ?? 'Unknown';
$currentRole = $GLOBALS['currentRole'] ?? $_SESSION['user_role'] ?? 'Unknown';

// Get menu items from GLOBALS (set by calling page) or fallback to basic menu
...
function renderAdminLayout($pageTitle, $content, $additionalCSS = '', $additionalJS = '') {
    global $currentUser, $currentRole, $menuItems;
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
                ...
                <div class="nav-item">
                    <a href="<?php echo $basePath; ?><?php echo $item['url']; ?>" class="nav-link">
                        <div class="nav-icon">
                            ...
                            elseif (strpos($item['url'], 'call_history') !== false) $icon = 'fas fa-phone';
                            elseif (strpos($item['url'], 'order_history') !== false) $icon = 'fas fa-shopping-cart';
                            ?>
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="<?php echo basename($item['url']); ?>" class="nav-link">
                        <div class="nav-icon">
                            <?php
                            $icon = 'fas fa-cog';
                            if (strpos($item['url'], 'distribution_basket') !== false) $icon = 'fas fa-inbox';
                            elseif (strpos($item['url'], 'waiting_basket') !== false) $icon = 'fas fa-hourglass-half';
                            elseif (strpos($item['url'], 'supervisor_dashboard') !== false) $icon = 'fas fa-chart-bar';
                            elseif (strpos($item['url'], 'intelligence_system') !== false) $icon = 'fas fa-brain';
                            elseif (strpos($item['url'], 'user_management') !== false) $icon = 'fas fa-users-cog';
                            elseif (strpos($item['url'], 'import_customers') !== false) $icon = 'fas fa-file-import';
                            ?>
                            <i class="<?php echo $icon; ?>"></i>
                        </div>
                        <span><?php echo $item['title']; ?></span>
        ...
        <div class="user-info">
            <div class="d-flex align-items-center gap-3">
                ...
                <a href="../../api/auth/logout.php" class="btn btn-sm btn-outline-primary">

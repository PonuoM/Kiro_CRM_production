...
// Check login and waiting basket permission
...
$additionalJS = '
    ...
    <script>
        ...
        function loadWaitingCustomers() {
            ...
            fetch(`../api/waiting/basket.php?${params}`)
                .then(response => response.json())
                .then(data => {
        ...
        function showCustomerDetail(customerCode) {
            fetch(`../api/waiting/basket.php?action=customer_history&customer_code=${customerCode}`)
                .then(response => response.json())
                .then(data => {
                    if (data.status === 'success') {
